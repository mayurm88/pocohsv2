...
${OBJECTDIR}/JsonPost.o: JsonPost.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JsonPost.o JsonPost.cpp
...
${TESTDIR}/tests/JsonPlaceHolderRunner.o: tests/JsonPlaceHolderRunner.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/JsonPlaceHolderRunner.o tests/JsonPlaceHolderRunner.cpp


${TESTDIR}/tests/JsonPlaceHolderTests.o: tests/JsonPlaceHolderTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/JsonPlaceHolderTests.o tests/JsonPlaceHolderTests.cpp
...
${OBJECTDIR}/JsonPost_nomain.o: ${OBJECTDIR}/JsonPost.o JsonPost.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JsonPost_nomain.o JsonPost.cpp;\
	else  \
